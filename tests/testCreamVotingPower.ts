...
const expectedVotingPower = [
  ...
  ethers.BigNumber.from("0"),
  ethers.BigNumber.from("0"),
  ethers.BigNumber.from("2331239647811632667"),
  ethers.BigNumber.from("0"),
  ethers.BigNumber.from("36299104271708067130"),
  ethers.BigNumber.from("0"),
  ethers.BigNumber.from("4965839018514079733"),
  ethers.BigNumber.from("0"),
  ethers.BigNumber.from("0"),
  ethers.BigNumber.from("0"),
  ethers.BigNumber.from("0"),
  ethers.BigNumber.from("0"),
  ethers.BigNumber.from("18688769521453371431"),
  ethers.BigNumber.from("3983416546541240060"),
  ethers.BigNumber.from("0"),
  ethers.BigNumber.from("0"),
  ethers.BigNumber.from("0"),
  ethers.BigNumber.from("0"),
